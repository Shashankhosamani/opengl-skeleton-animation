...
#define TORSO_RADIUS 0.7
#define UPPER_ARM_HEIGHT 4.0
#define UPPER_ARM_RADIUS  0.5
#define LOWER_ARM_HEIGHT 4.0
...
#define HEAD_RADIUS 1.5f
#define NECK_HEIGHT 3.0
#define NECK_RADIUS 0.8
#define SHOULDER_LINE 7.0
#define HIPLINE 5.0
#define MOVE 0.1

GLfloat TORSO_LENGTH = TORSO_HEIGHT * 2;
...
treenode torso_node, torso_node1, head_node, lua_node, rua_node, lll_node, rll_node,
...
void renderBackground() {
	...
	glBegin(GL_QUADS);
	glColor3f(1.0f, -0.3f, 0.1f);// Gray color for the road
	glVertex3f(-10.0f, -14.0f, -50.0f);
	glVertex3f(-10.0f, -14.0f, 50.0f);
	glVertex3f(10.0f, -14.0f, 50.0f);
	glVertex3f(10.0f, -14.0f, -50.0f);
	glEnd();
...
void torso()
{
	...
	gluSphere(t, TORSO_RADIUS * 1.3, 50, 50);
	glTranslatef(0.0, 0.0, TORSO_HEIGHT - 8);
	gluCylinder(t, TORSO_RADIUS, TORSO_RADIUS, TORSO_HEIGHT, 50, 50);
	gluSphere(t, TORSO_RADIUS * 1.3, 50, 50);
	glTranslatef(2.5, 0.0, TORSO_HEIGHT - 4);
	glRotatef(-90, 0, 1, 0);
	gluCylinder(t, TORSO_RADIUS - 0.1, TORSO_RADIUS - 0.1, HIPLINE, 50, 50);
	gluSphere(t, TORSO_RADIUS + 0.1, 50, 50);
	glTranslatef(-0.0, -0.0, HIPLINE);
	gluSphere(t, TORSO_RADIUS + 0.1, 50, 50);
	glPopMatrix();
}
...
void neck()
{
	...
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(nk, NECK_RADIUS - 0.1, NECK_RADIUS - 0.1, NECK_HEIGHT, 50, 50);
	gluSphere(nk, NECK_RADIUS * 1.2, 50, 50);
	glTranslatef(3.5, 0, 0);
	glRotatef(-90, 0, 1, 0);
	gluCylinder(nk, NECK_RADIUS - 0.3, NECK_RADIUS - 0.3, SHOULDER_LINE, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(relb, SHOULDER_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lelb, SHOULDER_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(relb, ELBOW_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lelb, ELBOW_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(rknee, SHOULDER_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lknee, SHOULDER_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(rknee, KNEE_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lknee, KNEE_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lknee, FOOT_RADIUS, 50, 50);
	glPopMatrix();
}
...
{
	glPushMatrix();
	gluSphere(lknee, HAND_RADIUS, 50, 50);
	glPopMatrix();
}
...
void left_upper_arm()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(lua, UPPER_ARM_RADIUS, UPPER_ARM_RADIUS - 0.1, UPPER_ARM_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void left_lower_arm()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(lla, LOWER_ARM_RADIUS - 0.1, LOWER_ARM_RADIUS - 0.15, LOWER_ARM_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void right_upper_arm()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(rua, UPPER_ARM_RADIUS, UPPER_ARM_RADIUS - 0.1, UPPER_ARM_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void right_lower_arm()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(rla, LOWER_ARM_RADIUS - 0.1, LOWER_ARM_RADIUS - 0.15, LOWER_ARM_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void left_upper_leg()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(lul, UPPER_LEG_RADIUS, UPPER_LEG_RADIUS - 0.1, UPPER_LEG_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void left_lower_leg()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(lll, LOWER_LEG_RADIUS - 0.1, LOWER_LEG_RADIUS - 0.2, LOWER_LEG_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void right_upper_leg()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(rul, UPPER_LEG_RADIUS, UPPER_LEG_RADIUS - 0.1, UPPER_LEG_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void right_lower_leg()
{
	glPushMatrix();
	glRotatef(-90.0, 1.0, 0.0, 0.0);
	gluCylinder(rll, LOWER_LEG_RADIUS - 0.1, LOWER_LEG_RADIUS - 0.2, LOWER_LEG_HEIGHT, 50, 50);
	glPopMatrix();
}
...
void inverseKinematics()
{
	...
	case 0: case -6:
		...
		glLoadIdentity();
		glTranslatef(HIPLINE / 2, -TORSO_LENGTH / 2, 0.0);
	...
	case 1: case -3:
			if (theta[9] < 180.0)
			{
				...
				theta[3] += 0.3 * MOVE;
				theta[4] += 0.2 * MOVE;
				horizontal -= 0.001 * MOVE;
				tZ += 0.0035;

			}
			else if (theta[7] < 180.0)
			{
				theta[9] -= 0.1 * MOVE;
				theta[10] += 0.003 * MOVE;
				theta[7] += 0.3 * MOVE;
...
void myinit()
{
	...
	glLoadIdentity();
	glTranslatef(SHOULDER_LINE - 11, 1.1 * TORSO_HEIGHT, 0.0);
	...
	glLoadIdentity();
	glTranslatef(SHOULDER_LINE - 3, 1.1 * TORSO_HEIGHT, 0.0);
	...
	glRotatef(theta[7], 1.0, 0.0, 0.0);
	glGetFloatv(GL_MODELVIEW_MATRIX, llhip_node.m);
	llhip_node.f = lefthip;
	llhip_node.sibling = &rlhip_node;
	llhip_node.child = &lul_node;
	*/

	glLoadIdentity();
	glTranslatef(-HIPLINE + 2.5, -TORSO_LENGTH / 2, 0.0);
	glRotatef(theta[7], 1.0, 0.0, 0.0);
	glGetFloatv(GL_MODELVIEW_MATRIX, lul_node.m);
